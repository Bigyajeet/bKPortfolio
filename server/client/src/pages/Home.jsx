    ...
    <>
      <div className="container hero">
        <section className="hero-left">
          ...
          <h1 className="h1">
            Hi, I’m <span className="gradient">Bigyajeet Kumar Patra</span>
          </h1>
          <p className="subtitle">
            I design and ship responsive web apps, automate workflows with n8n,
            and use Python ML to turn data into features.
          </p>
          ...
          <div className="metrics">
            ...
            <div className="metric">
              ...
              <div className="label">DSA problems</div>
            </div>
            <div className="metric">
          ...
          <div className="row ctas">
            <button className="btn" type="button" onClick={openRecruiter}>
              Recruiter Mode
            </button>
            ...
            <button className="btn btn-plain" type="button" onClick={emailMe}>
              Email me
            </button>
